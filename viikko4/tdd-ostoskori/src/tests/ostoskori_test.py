...
class TestOstoskori(unittest.TestCase):
    ...
    def test_poistettaessa_toinen_kahdesta_samasta_tuotteesta_jattaa_ostos_olion_maaralla_yksi(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
        self.kori.lisaa_tuote(maito)
    ...
    def test_poistettaessa_viimeinen_kappale_ostoksesta_ei_korissa_ole_ostos_olioita(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
        self.kori.poista_tuote(maito)
